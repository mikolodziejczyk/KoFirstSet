...
var App = /** @class */ (function () {
    function App() {
        ...
        this.save = function () {
            var data = ko.toJS(_this.entries);
            var serialized = JSON.stringify(data);
            $("#saveTarget").text(serialized);
        };
        for (var i = 1; i <= 12; i++) {
            this.entries.push(new __WEBPACK_IMPORTED_MODULE_0__entry__["a" /* Entry */]("2015-" + i.toString()));
        }
...
/******/ });
//# sourceMappingURL=Templates_Edit.js.map